    ...
    >
      <div className="flex-1 p-6 overflow-hidden flex flex-col h-screen">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <h1 className="text-3xl font-orbitron font-bold text-foreground">Board</h1>
        ...
        <DragOverlay>
          {activeTask && (
            <div className="glass-strong rounded-lg p-4 border border-primary/50 shadow-2xl opacity-90 w-[300px]">
              <h4 className="font-exo font-medium text-foreground line-clamp-2">{activeTask.title}</h4>
            </div>
          )}
        </DragOverlay>

        {/* Modals */}
        <CreateTaskModal open={createModalOpen} onOpenChange={setCreateModalOpen} columns={columns} />
